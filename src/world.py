...
class World:
    ...
    def compute(self, nb_relaxation_iterations: int = 1000):
        ...
        self._magnetic_field = Biot.solve(self._circuit_current, self._coordinate_system, self.delta_q1, self.delta_q2)

        self._energy_flux = 1/mu_0*(VectorField.cross(self._electric_field, self._magnetic_field))
